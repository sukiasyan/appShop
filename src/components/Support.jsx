      ...
      <div className='max-w-[1240px] mx-auto text-white relative'>
        <div className='px-4 py-12'>
          ...
          <p className='py-4 text-3xl text-slate-300'>
            Loream ipsum pp ipsum Loream ipsum pp ipsum Loream ipsum pp ipsum
            Loream ipsum pp ipsum Loream ipsum pp ipsum Loream ipsum pp ipsum
            Loream ipsum pp ipsum
          </p>
        </div>
          ...
          <div className='bg-white rounded-xl shadow-2xl'>
            <div className='p-8'>
              ...
              <p className='text-gray-600 text-xl'>
                Loream ipsum pp ipsum Loream ipsum pp ipsum Loream ipsum pp
                ipsum Loream ipsum pp ipsum Loream ipsum pp ipsum Loream ipsum
                pp ipsum Loream ipsum pp ipsum
              </p>
            </div>
